...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        f"🎉Congrats! You are using M⃠R⃠ K⃠A⃠I⃠F⃠:\n\n"
        ...
        f"**If you have any questions, feel free to ask [🅱︎🅴︎🆁︎🅻︎ï🅽︎](https://t.me/txtuploder)! 💬**\n"
        )
    ) 
...
async def txt_handler(bot: Client, m: Message):
    ...
    if raw_text3 == '1':
        CR = '[M⃠R⃠ K⃠A⃠I⃠F⃠](https://t.me/txtuploder)'
    else:
        CR = raw_text3
            ...
            try:
                ...
                if "drive" in url:
                    ...
                    Show = f"🚀𝐏𝐫𝐨𝐠𝐫𝐞𝐬𝐬 » {progress:.2f}%\n┃\n" \
                           ...
                           f"╰━✦𝐁𝐨𝐭 𝐌𝐚𝐝𝐞 𝐁𝐲 ✦ [M⃠R⃠ K⃠A⃠I⃠F⃠](https://t.me/txtuploder)"
